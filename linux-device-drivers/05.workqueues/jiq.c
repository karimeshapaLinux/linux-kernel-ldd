...
static struct proc_ops jiq_read_wq_fops = {
...
static struct proc_ops jiq_read_wq_delayed_fops = {
...
static struct proc_ops jiq_read_tasklet_fops = {
...
static struct proc_ops jiq_read_run_timer_fops = {
